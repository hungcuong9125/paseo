...
| [docs/role-binding.md](docs/role-binding.md)                         | Native Lead/Peer/Supervisor roles — capability detection, immutable bindings, per-provider injection, scope vs doctrine fork   |
| [docs/role-binding-port-report.md](docs/role-binding-port-report.md) | Point-in-time record of the 2026-08-17 port from paseo-doctrine-downstream — files, tests, deviations                          |
